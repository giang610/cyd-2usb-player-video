...
#define PLAYBACK_SPEED 1.4542f       // Speed multiplier (1.0 = normal, 1.4542 = 45% faster)
#define TARGET_FPS     24.0f         // Original video FPS (adjust if your video is different)
...
void mjpegPlayFromSDCard(char *mjpegFilename)
{
    ...
    else
    {
        ...
        while (!skipRequested && mjpegFile.available() && mjpeg.readMjpegBuf())
        {
            ...
            // Speed control: wait if frame rendered faster than target interval
